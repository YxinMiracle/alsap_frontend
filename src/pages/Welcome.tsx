import { CarData, CarInfo } from '@/constants/car/carConstants';
...
const Welcome: React.FC = () => {
  ...
  class Navbar {
    ...
    constructor() {
      ...
      this.adjust(); // 可选：在构造函数中调用 adjust 方法来设置初始状态
    }
  ...
  class Car {
    ...
    private _create(info: CarInfo[]): void {
      info.forEach((car) => {
        ...
        const audio = new Audio(`../../utils/sound/${car.sound_effect}`);
    ...
    private _clearTimer(timer: NodeJS.Timeout | null): void {
    ...
    // Remember to remove event listeners and clean up when the object is done
    public cleanup(): void {
      this.data.forEach(({ dom, listener }) => {
        dom.removeEventListener('click', listener.click);
        dom.removeEventListener('dblclick', listener.dbclick);
      });
    }
  }
  ...
  const loadAnimation = () => {
    ...
    tween.from('header', { duration: 0.5, ease: 'power2', y: -16 * 6 }); // 从哪里来
    tween.to('header', { duration: 0.5, transition: 0.3 }); // 到哪里去
    ...
    <div className="root">
      ...
      <section className="content">
        <aside className="info">
          ...
          {/*  <br />*/}
          {/*  SpringBoot、MQ、SpringCloud、SpringSecurity、JUT并发、*/}
          {/*  <br />*/}
          {/*  ElasticSearch、知识图谱等技术*/}
          {/*</h3>*/}
      ...
      <div className="menu">
        <i onClick={menuIconClick} className="uil uil-apps">
          xxx
        </i>
